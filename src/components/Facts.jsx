...
function Facts() {
  return (
    <div className="flex flex-col items-center min-h-screen w-full bg-gradient-to-t from-slate-900 to-gray-900 text-white">
      <h1
        className="text-2xl sm:text-3xl md:text-5xl lg:text-7xl lg:my-10"
        data-aos="zoom-in"
      >
        බයිබලයේ ඉතිහාසය
      </h1>
      <ul
        className="grid grid-cols-1 gap-x-2 gap-y-2 my-10 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 px-2 lg:mx-4"
      ...
      <section className="text-lg text-white mb-10 sm:grid sm:grid-cols-2 md:text-xl md:leading-relaxed lg:text-2xl lg:leading-relaxed lg:mx-4">
        ...
        <Fact icon={IoMdInformationCircle}>
